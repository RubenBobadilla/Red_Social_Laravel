    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card pub_image pub_image_detail">
                ...
                <div class="card-body">
                    <div class="image-container image-datail">
                    ...
                    <div class="likes">
                        <!-- Comprobar si el usuario le dio Like a la Img -->
                        <?php $user_like = false; ?>
                        ...
                        @else
                        <img src="{{asset('img/heart_gray.png')}}" data-id="{{$image->id}}" class="btn-like" />                        
                        @endif
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Si eliminas esta imagen, no la podras recuperar nunca. ¿Estas seguro de que deseas eliminarla?
                                    </div>
